...
export default function StoryModeNavigation({ tabs, activeIndex, setActiveIndex }) {
  ...
  return (
    <MainBlock>
      ...
      <Icon>
        <AssemblyIcon progress={progressBar / 100} />
      </Icon>
