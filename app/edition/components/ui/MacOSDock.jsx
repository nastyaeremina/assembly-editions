...
function DockIcon({ children, mouseX, label, hasIndicator, showTooltip = true }) {
...
const DOCK_ICONS = [
  { label: "Assembly", hasIndicator: false, src: "/edition/dock-icons/swap.svg", padding: "7px" },
  { label: "Music", hasIndicator: false, src: "/edition/dock-icons/Bitmap.svg" },
  { label: "Podcasts", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-13.svg" },
  { label: "Apple TV", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-12.svg" },
  { label: "Launchpad", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-11.svg" },
  ...
  { label: "Contacts", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-6.svg" },
  ...
  { label: "News", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-3.svg" },
  { label: "System Settings", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-2.svg" },
  { label: "TextEdit", hasIndicator: false, src: "/edition/dock-icons/_System App Icon-1.svg" },
  { label: "Preview", hasIndicator: false, src: "/edition/dock-icons/App Icon.svg" },
