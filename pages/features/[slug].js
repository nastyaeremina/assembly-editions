  ...
  const renderHeroSection = useMemo(() => {
    switch (module) {
      ...
      case MUDULE_LIST.CONTRACT:
        return (
          <>
            <Navbar isModule={true} headerIndex={HEADER_LIST.CONTRACT} />
            <ContractHero>
              <Container>
      ...
      case MUDULE_LIST.KNOWLEDGE:
        return (
          <>
            <Navbar isModule={true} headerIndex={HEADER_LIST.KNOWLEDGE} />
            <KnowledgeHero>
              <Container>
                <KnowHero>
      ...
      default:
        return (
          <>
            <Navbar isModule={true} headerIndex={HEADER_LIST.DEFAULT} />
          </>
        );
    }
  }, [module]);
