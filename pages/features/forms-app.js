...
import { FEATURES_FORMS_TAB_ID, HEADER_LIST, HOME_MODULE_LIST, MODULE_COLOR_LIST, MODULE_GRADIENT_IMAGE_LIST, MUDULE_LIST, NAVBAR_COLOR_LIST } from "../../constants/constant";
    ...
    return (
        <>
            ...
            <Layout>
                ...
                <Container>
                    <BottomFunction>
                        <TabView tabId={FEATURES_FORMS_TAB_ID} bgColor={MODULE_COLOR_LIST[HOME_MODULE_LIST['Forms']]?.bgColor} textColor={MODULE_COLOR_LIST[HOME_MODULE_LIST['Forms']]?.fontColor} />
                    </BottomFunction>
                </Container>
                <Tools />
