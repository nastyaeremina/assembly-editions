...
export default function ClientHeroSection() {
  return (
    <HeroSection>
      <Container>
        <HeroHeading>The client portal from the future</HeroHeading>
        <Para>
          Give your clients a one-stop shop experience with a portal that streamlines messaging, payments, file-sharing,
          help centers, custom app access, and more.
        </Para>
        ...
        <MainImage>
          <Image src={client} alt='internal' className='heromain-image' />
        </MainImage>
      </Container>
    </HeroSection>
  );
