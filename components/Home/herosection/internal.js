...
export default function InternalHeroSection() {
  return (
    <HeroSection>
      <Container>
        <HeroHeading>One app to run your services business</HeroHeading>
        <Para>
          Message clients, open invoices, organize files, send eSignature requests, share forms, create help desks, use
        ...
        <MainImage>
          <Image src={internal} alt='internal' className='heromain-image' />
        </MainImage>
      </Container>
    </HeroSection>
  );
