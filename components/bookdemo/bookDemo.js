...
import { MainSection, FormSection, FormTxt, FormDetail, Input, NameBlock, NameInfo, LastText, ImgWrap } from './styles';
  ...
  return (
    <MainSection>
      <FormSection>
        ...
        <Button text={'Let’s talk'} href={'#'} className='btnposition' />
        <LastText>
