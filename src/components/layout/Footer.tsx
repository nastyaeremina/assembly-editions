...
function LinkColumn({
  ...
  subsections?: { title: string; links: { label: string; href: string }[] }[];
}) {
  return (
    <div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        ...
        {/* Row 2 — 3 columns aligned to first 3 of row 1 */}
        <div className="mt-16 grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-4">
          ...
          {/* Empty 4th column to keep alignment */}
          <div />
        </div>

      </div>

      {/* Assembly logo — full-width billboard */}
      <FooterLogo />
    </footer>
  );
}
